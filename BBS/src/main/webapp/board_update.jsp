...
<body>
	...
	<div class="container">
		<div class="row">
			<form  method="post" action="board_updateAction.jsp?pageNumber=<%=pageNumber%>">
					...
					<tbody>
						<tr>
							<td>
								...
								value="<%=board.getBoardTitle() %>" maxlength="50">
							</td>
						</tr>	
						<tr>
							<td>
								<textarea class="form-control" placeholder="글 내용" name="boardContent" 
									maxlength="2048" style="height: 350px; resize: none;" ><%=board.getBoardContent() %>"</textarea>
							</td>
						</tr>
					</tbody>
				</table>
